...
<br /><br /><a href='https://www.headrushlearning.com/' target='_blank' rel="noopener noreferrer" style={{color: 'white',
            opacity: '1!important',
            fontSize: '20px'}}>< FontAwesomeIcon icon={faLink} /></a>
            </p>
            </div>
            ...
            <br /><br /><a href='http://acousticsaturdays.com/' target='_blank' rel="noopener noreferrer" style={{color: 'white',
            opacity: '1!important',
            fontSize: '20px'}}>< FontAwesomeIcon icon={faLink} /></a>
            </p>
            </div>
            ...
            <br /><br /><a href='https://mystifying-chandrasekhar-9563f5.netlify.com/' target='_blank' rel="noopener noreferrer" style={{color: 'white',
            opacity: '1!important',
            fontSize: '20px'}}>< FontAwesomeIcon icon={faLink} /></a>
            </p>
            </div>
            ...
            <br /><br /><a href='https://competent-jang-49a5f5.netlify.com/' target='_blank' rel="noopener noreferrer" style={{color: 'white',
            opacity: '1!important',
            fontSize: '20px'}}>< FontAwesomeIcon icon={faLink} /></a>
            </p>
            </div>
