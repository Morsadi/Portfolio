...
export const SocialMedia = props => {
  ...
  return (
    <div id='socialMedia'>
      <button
        style={{ color: props.socialBtn.twitter }}
        onMouseEnter={props.socialHoverOn}
        onMouseLeave={props.socialHoverOff}
        onClick={() => {
          twitter();
        }}
        name='twitter'
      ...
      <button
        style={{ color: props.socialBtn.linkedIn }}
        onMouseEnter={props.socialHoverOn}
        onMouseLeave={props.socialHoverOff}
        onClick={() => {
          linkedIn();
      ...
      <button
        style={{ color: props.socialBtn.email }}
        onMouseEnter={props.socialHoverOn}
        onMouseLeave={props.socialHoverOff}
        onClick={() => {
          email();
