...
class App extends Component {
  ...
  changeMe(e) {
    if (e === 'TGS') {
      this.setState({
        opacity: 0,
        logoOpacity: { TGS: 1, HEADRUSH: 0.3, ACOUSTICS: 0.3, pblr: 0.3, scaler: 0.3 },
        link: 'https://alumni.tgs.org/'
      });
      ...
      this.setState({
        opacity: 0,
        logoOpacity: { TGS: 0.3, HEADRUSH: 0.3, ACOUSTICS: 1, pblr: 0.3, scaler: 0.3 },
      ...
      this.setState({
        opacity: 0,
        logoOpacity: { TGS: 0.3, HEADRUSH: 1, ACOUSTICS: 0.3, pblr: 0.3, scaler: 0.3 },
      ...
      >
        <div className='navigation'>
          <nav className='navbar navbar-expand-lg navbar-light'>
            <span onClick={this.home.bind(this)} className='navbar-brand about name'>BADR MORSADI</span>
            ...
            <span
              className={
                this.state.aboutClicked
                  ? 'navbar-brand about right active'
                  : 'navbar-brand about right'
              }
              onClick={() => this.about()}
            >
              About
        ...
        >
          {this.state.homeClicked ? <Tagline /> : null}
        </CSSTransitionGroup>
